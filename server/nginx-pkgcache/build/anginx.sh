...
#
#    build/nginx.sh
#      Build/Installation file for ldc-alpine:anginx-pkgcache-0.1.0-b4
#
# ========================================================================================
#
# @author Jay Wheeler.
...
echo
echo "Completed build of ldc-alpine:anginx-pkgcache-0.1.0-b4 from ldc-alpine:abase-0.1.0-b4"
echo
