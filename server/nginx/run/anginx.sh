...
# ========================================================================================
#
#      Run/Install file for anginx-0.1.0-b4 from ldc-alpine:anginx-0.1.0-b4.
#
# ========================================================================================
#
# @author Jay Wheeler.
...
echo
echo "Installing and starting anginx-0.1.0-b4 from ewsdocker/ldc-alpine:anginx-0.1.0-b4"
echo
...
[[ $? -eq 0 ]] ||
 {
 	echo "Unable to install/run anginx-0.1.0-b4 from ewsdocker/ldc-alpine:anginx-0.1.0-b4"
 	exit 2
 }

echo
echo "Successfully installed anginx-0.1.0-b4 from ewsdocker/ldc-alpine:anginx-0.1.0-b4"
echo
